    ...
    <>
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <select
          ...
          className={`cursor-pointer rounded px-2.5 py-2 text-sm outline outline-1 outline-gray-300 focus:outline-1 focus:outline-offset-0 focus:outline-gray-300 md:py-2.5 md:text-base ${
      ...
      <Input
        ...
        rows={4}
        className="rounded text-sm outline outline-1 outline-gray-500 md:text-base"
